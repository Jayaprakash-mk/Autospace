...
-- CreateEnum
CREATE TYPE "ServiceType" AS ENUM ('WASHING', 'PAINTING', 'MECHANIC', 'TIRE_ROTATION', 'FUEL_TOP_UP', 'INTERIOR_CLEANING', 'EV_CHARGING');
...
CREATE TABLE "Service" (
    ...
    CONSTRAINT "Service_pkey" PRIMARY KEY ("uid")
);
...
CREATE TABLE "ServiceAssignment" (
    ...
    CONSTRAINT "ServiceAssignment_pkey" PRIMARY KEY ("serviceId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Service_companyId_uid_key" ON "Service"("companyId", "uid");
...
-- CreateIndex
CREATE UNIQUE INDEX "ServiceAssignment_bookingId_serviceType_key" ON "ServiceAssignment"("bookingId", "serviceType");
...
-- AddForeignKey
ALTER TABLE "Service" ADD CONSTRAINT "Service_uid_fkey" FOREIGN KEY ("uid") REFERENCES "User"("uid") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ServiceAssignment" ADD CONSTRAINT "ServiceAssignment_assignedServiceId_fkey" FOREIGN KEY ("assignedServiceId") REFERENCES "Service"("uid") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ServiceAssignment" ADD CONSTRAINT "ServiceAssignment_bookingId_fkey" FOREIGN KEY ("bookingId") REFERENCES "Booking"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BookingTimeline" ADD CONSTRAINT "BookingTimeline_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "Service"("uid") ON DELETE SET NULL ON UPDATE CASCADE;
