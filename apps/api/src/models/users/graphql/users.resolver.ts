...
import { RegisterWithProvidedInput, RegisterWithCredentialsInput, LoginInput, LoginOutput } from './dtos/create-user.input'
...
export class UsersResolver {
  ...
  async registerUserWithCredentials(
    @Args('registerUserWithCredentialsInput')
  ...
  async registerUserWithProvider(
    ...
    args: RegisterWithProvidedInput,
  ){
